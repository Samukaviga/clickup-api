...
class TaskMetasGlobaisCommand extends Command
{
  
    protected $signature = 'app:task-metas-globais-command';
    ...
    public function handle()
    {
        ...
        do {
            ...
            $folder = $this->clickUpService->getTasks("901109507318", $page);

            if(!empty($folder['tasks'])){
                TaskList::updateOrCreate(
                    ['list_id' => "901109507318"],
