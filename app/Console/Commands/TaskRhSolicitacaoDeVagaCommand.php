...
class TaskRhSolicitacaoDeVagaCommand extends Command
{

    protected $signature = 'app:task-rh-solicitacao-de-vaga-command';
    ...
    public function handle()
    {
        ...
        do {
            ...
            $folder = $this->clickUpService->getTasks("901109415469", $page);

            if (!empty($folder['tasks'])) {
                TaskList::updateOrCreate(
                    ['list_id' => "901109415469"],
